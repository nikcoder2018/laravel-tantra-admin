        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">
              <strong class="card-title">Archive List</strong>
            </div>
            <div class="card-body">
                    ...
                    @foreach($packages as $key=>$list)
                      <tr>
                        ...
                        <td>
                          ...
                          <button type="button" class="btn btn-danger btn-sm" onclick="undoPackage({{$list->id}})"><i class="fa fa-undo"></i> Undo</button>
                        </td>
                      </tr>
                    @endforeach
                  @endif
